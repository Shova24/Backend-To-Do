...
import { createTask, deleteTask, getTasks, redoTask, deleteToTrash, updateTask } from "../Controllers/TaskController";
...
router.patch("/update-in-trash/:id", AuthorizedUser, deleteToTrash);
